        ...
        CASE (V_PIECE_SOURCE)
          ...
          --Torre      
           ...
           --Alfil 
             ...
             WHEN 'a'  THEN MOVES_PQ01.MOVE_A(P_CORD_SOURCE,P_CORD_TARGET,V_PIECE_SOURCE,V_STATUS_PIECE);
           --Rey
             WHEN 'R'  THEN MOVES_PQ01.MOVE_R(P_CORD_SOURCE,P_CORD_TARGET,V_PIECE_SOURCE,V_STATUS_PIECE);
...
END MOVE_PIECE;
 ...
 PROCEDURE MOVE_R (P_CORD_SOURCE VARCHAR2, P_CORD_TARGET VARCHAR2, P_PIECE VARCHAR2, P_STATUS_PIECE VARCHAR2 ) IS
 BEGIN
 DBMS_OUTPUT.PUT_LINE('FALTA');
 END MOVE_R;
